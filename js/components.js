...
const footerTemplate = `
    ...
    <!-- TOMBOL FLOATING QUICK-HOME & BACK TO TOP -->
    <a href="#top" id="floating-home-btn" aria-label="Kembali ke Beranda Atas" class="fixed bottom-6 right-6 z-40 bg-brand-primary text-white w-12 h-12 rounded-2xl shadow-xl border border-white/10 flex items-center justify-center transform translate-y-20 opacity-0 pointer-events-none transition-all duration-300 hover:bg-brand-yellow hover:text-brand-primary hover:scale-105 active:scale-95 group">
        <i class="fa-solid fa-house text-sm group-hover:-translate-y-0.5 transition-transform duration-200"></i>
    </a>
